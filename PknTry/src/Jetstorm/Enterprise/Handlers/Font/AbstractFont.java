...
public abstract class AbstractFont {
	 ...
	 */
	public static String defaultSequence = " !\"#$%&'()*+,-./0123456789:;<=>?@"
			+ "ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";

	/**
	 * Writes a one-line text (well, it wraps if the text exceeds 999999 pixels
	 * in width)
	 * 
	 * @param graphics
	 ...
	 *            - the string to write
	 * @param x
	 *            - the x coordinate to start writing at
	 * @param y
	 *            - the y coordinate to start writing at
	 */
	...
	/**
	 * Writes a text of a given width that can be aligned. If the text is wider
	 * than width, the text wraps to the next line
	 * 
	 * @param graphics
	 *            - the graphics context
	 * @param s
	...
	/**
	 * Writes a text of a given width, vspace and indentation that can be
	 * aligned. If the text is wider than width, the text wraps to the next line
	 * 
	 * @param graphics
	 *            - the graphics context
	 * @param s
	 ...
	 *            - the maximum width of one line of text
	 * @param vspace
	 *            - The extra whitespace to leave between lines. Can be positive
	 *            or negative.
	 * @param indentation
	 *            - The amount of pixels to indentate the text. Can be positive
	 *            or negative.
	 * @return the number of written rows
	 */
	public abstract int write(Graphics graphics, String s, int alignment, int x, int y, int width, int vspace,
			int indentation);
