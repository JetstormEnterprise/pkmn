...
public class PokemonHealer extends MapObject {

	private BufferedImage[] image;

	public PokemonHealer(TileMap tm) {
		super(tm);
		init();
	}
	...
	private void init() {
		...
		try {
			...
			image[0] = ImageIO.read(getClass().getResourceAsStream("/entities/pokemonhealing.png"));
